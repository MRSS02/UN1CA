...
# Frameworks
# SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_b5q_sm8550

# Lockscreen
# SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,type:circle

# Device specific
# SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy Z Flip5
...
# Camera values intentionally differ from S26U or need b5q camera IDs.
SEC_FLOATING_FEATURE_CAMERA_CONFIG_SDK_FEATURE_INFO=version2,super_night,preview_dis,video_hdr,smooth_zoom,logical_rear_camera:camera_id=20,exposure_table_control,selfie_tone
SEC_FLOATING_FEATURE_CAMERA_CONFIG_WINE_DETECTOR=V1_SNAP_CPU

# Framework/UI values are Z Flip5-specific or intentionally different from S26U.
SEC_FLOATING_FEATURE_COMMON_CONFIG_DEX_MODE=wireless,dexforpc
