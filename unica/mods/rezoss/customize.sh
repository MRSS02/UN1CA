...
# Base Overlay
# =============================================================================
ADD_TO_WORK_DIR "$MODPATH" "product" "overlay/framework-res__dm1qxxx__auto_generated_rro_product.apk" 0 0 644 "u:object_r:system_file:s0"
...
EVAL "sed -i 's/fileencryption=aes-256-xts:aes-256-cts:v2+inlinecrypt_optimized+wrappedkey_v0,metadata_encryption=aes-256-xts:wrappedkey_v0/encryptable/g' $WORK_DIR/vendor/etc/fstab.qcom"
EVAL "/work_dir/vendor/etc/fstab.qcom"
