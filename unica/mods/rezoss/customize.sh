...
# Base Overlay
# =============================================================================
ADD_TO_WORK_DIR "$MODPATH/product/overlay" "product" "product/overlay/framework-res_dm1qxxx_auto_generated_rro_product.apk" 0 0 644 "u:object_r:system_file:s0"
